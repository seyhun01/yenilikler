...
-- funtion 1
create function dbo.Age(@Id int)
returns int
As 
begin
declare @age int
select @age= Age from Footballer
where Id=@Id
return @age
end ;
Select *,dbo.Age(Id) from Footballer 
select dbo.Age(2)
-- function 2
create function dbo.Country (@Name nvarchar )
returns nvarchar(50)
as begin
declare @country nvarchar(50)
select  @country= Country from Models
where Name=@Name
return @country
end;
Select *, dbo.Country(Name) from Models
